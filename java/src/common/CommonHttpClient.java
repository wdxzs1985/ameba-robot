...
public class CommonHttpClient {
	...
	public String get(final String url) {
		...
		final RequestConfig defaultRequestConfig = RequestConfig.custom()
				...
				.setConnectionRequestTimeout(CommonHttpClient.TIMEOUT).build();
	...
	public void loadCookie(final File cookieFile) {
		...
		try {
			...
			for (final String line : lines) {
				...
				final long expires = Long.valueOf(StringUtils.split(
						cookieValue[3], "=")[1]);
				final int version = Integer.valueOf(StringUtils.split(
						cookieValue[4], "=")[1]);
				final boolean secure = Boolean.valueOf(StringUtils.split(
						cookieValue[5], "=")[1]);
