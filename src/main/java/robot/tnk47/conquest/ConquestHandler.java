...
public class ConquestHandler extends Tnk47EventHandler {
    ...
    // private static final Pattern AREA_TOP_PATTERN =
    // Pattern.compile("<a href=\"/conquest/conquest-area-top\" class=\"actBtn btnMainWire\" >");
    ...
    protected String handleIt() {
        ...
        if (ConquestHandler.BATTLE_PATTERN.matcher(html).find()) {
